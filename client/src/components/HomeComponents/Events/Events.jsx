        ...
        <div style={style} className={`img-slider-slide ${isActive ? "brightness-110 scale-110" : "brightness-50"}`}>
            <div className='relative w-[15rem] mx-10 hover:scale-105 transition cursor-pointer'>
                ...
                <div className='absolute flex justify-between py-3 px-3 bottom-5 w-full bg-gray-900 bg-opacity-25 backdrop-blur'>
                    ...
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" className="font-bold" height="32" width="32" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z"></path></svg>
                </div>
            </div>
        </div>
    );
